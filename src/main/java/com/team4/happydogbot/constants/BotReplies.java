...
public class BotReplies {
    ...
    public static final String MESSAGE_TEXT_GREETINGS = "Приветствую! Чтобы найти то, что тебе нужно - нажми на нужную кнопку";
    ...
    public static final String MESSAGE_TEXT_SHELTER_ABOUT = "Приют для бездомных животных «HappyDog» создан Городским " +
    ...
    public static final String MESSAGE_TEXT_SHELTER_SCHEDULE_ADDRESS = "Приют расположен по адресу Томская область, Томский район, " +
    ...
    public static final String MESSAGE_TEXT_SHELTER_SAFETY = "Правила техники безопасности:\n" +
    ...
    public static final String MESSAGE_TEXT_SEND_CONTACT = "Пожалуйста, введите ваше имя, фамилию и номер телефона через пробел";
    public static final String MESSAGE_TEXT_SEND_CONTACT_SUCCESS = "Данные успешно записаны";
    ...
    public static final String MESSAGE_TEXT_PET_RULES = "Перед посещение приюта ознакомьтесь, как правильно контактировать" +
            ...
            "8. То самое место.";
    public static final String MESSAGE_TEXT_PET_DOCS = "Перечень необходимых документов:\n" +
            "1) Паспорт.\n" +
    ...
    public static final String MESSAGE_TEXT_PET_TRANSPORT = "Лучше приехать за животным на своей машине или нанять такси." +
    ...
    public static final String MESSAGE_TEXT_PET_HOUSE_ADULT = "Если вы планируете заводить взрослую собаку, необходимо:\n" +
            "1. Позаботьтесь о безопасности в доме. Собаки могут грызть провода и играть с ними, " +
            "поэтому все электрокабели необходимо провести по верху или спрятать в специальные короба под плинтус. " +
            "Уберите потенциально опасные предметы со столиков и нижних полок: стеклянные и фарфоровые вазы, " +
            "мелкие безделушки, бытовую химию.\n" +
            ...
            "5. Вам потребуются средства для ухода за питомцем: щетка для расчесывания шерсти, шампунь для мытья, " +
            "зубная паста и щетка, лосьоны для чистки глаз и ушей.\n";
    public static final String MESSAGE_TEXT_PET_HOUSE_SICK = "Если вы планируете заводить собаку c ограниченными возможностями, необходимо:\n" +
            "1. Позаботьтесь о безопасности в доме. Собаки могут грызть провода и играть с ними, " +
            "поэтому все электрокабели необходимо провести по верху или спрятать в специальные короба под плинтус. " +
    ...
    public static final String MESSAGE_TEXT_PET_ADVICES = "Cоветы кинолога:\n" +
    ...
    public static final String MESSAGE_TEXT_PET_CYNOLOGISTS = "Проверенные кинологи:\n" +
    ...
    public static final String MESSAGE_TEXT_PET_REFUSAL = "Почему могут не дать животное в приюте:\n" +
