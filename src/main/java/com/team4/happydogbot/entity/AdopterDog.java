...
/**
 * Класс, описывающий пользователя (adopterDog), как потенциального усыновителя собаки
 * @param 'status' поле для отображения статуса пользовательского состояния * (отображает этап или состояние, в котором находится пользователь)
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
